    ...
    async fn status(&self, state: &Arc<AppState>) -> ServiceStatus {
        ...
        ServiceStatus {
            ...
            stats: serde_json::json!({
                ...
                {"name": "list_knowledge_bases", "label": "列出知识库", "desc": "列出所有已启用 MCP 的知识库，含 ID、名称、文档数、切片数"},
                {"name": "read_document", "label": "读取文档", "desc": "读取知识库中指定文档的完整内容"},
                {"name": "ask_knowledge_base", "label": "RAG 问答", "desc": "基于知识库内容的 RAG 智能问答，返回 AI 生成的回答及来源引用"},
                {"name": "get_knowledge_base_stats", "label": "知识库统计", "desc": "获取知识库详细统计：文档数、切片数、Token 数、索引状态"},
                {"name": "create_knowledge_base", "label": "创建知识库", "desc": "创建新知识库，支持自定义名称、描述、向量模型"},
                {"name": "update_knowledge_base", "label": "更新知识库", "desc": "更新知识库配置：名称、描述、分块大小、MCP 开关等"},
                {"name": "delete_knowledge_base", "label": "删除知识库", "desc": "永久删除知识库及其所有文档、切片和索引"},
                {"name": "upload_document", "label": "上传文档", "desc": "上传文档到知识库，自动解析→分块→向量化→索引"},
                {"name": "delete_document", "label": "删除文档", "desc": "删除知识库中的指定文档及其切片和向量"},
                {"name": "list_documents", "label": "文档列表", "desc": "列出知识库中所有文档及处理状态、切片数、Token 数"},
